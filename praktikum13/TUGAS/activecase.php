...
<head>
    ...
    <title>Chart Active Case COVID-19</title>
...
<body>
	<h2><center>GRAFIK PERBANDINGAN KASUS AKTIF COVID-19 DI 10 NEGARA</center></h2><br>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					label: 'Kasus Aktif Covid-19',
					data: <?php echo json_encode($active_case); ?>,
					backgroundColor: 'rgba(400, 20, 12, 0.7)',
